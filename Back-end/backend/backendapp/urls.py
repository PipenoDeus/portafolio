...
urlpatterns = [
    ...
    path('api/get-user-data/', api_get_user_data, name='api_get_user_data'),
    ...
    path('api/upload_image_gym/', upload_image_gym, name='upload_image_gym'),
    ...
    path('api/reservas-publicas/', api_reservas_publicas, name='api_reservas_publicas'),
    path('api/torneo/<uuid:torneo_id>/', api_detalle_torneo),
    path('api/torneo/<uuid:torneo_id>/inscribir/', api_inscribir_torneo),
    path('api/torneo/<uuid:torneo_id>/participantes/', api_participantes_torneo),
    path('api/torneo/eliminar/', api_delete_torneo_admin, name='api_delete_torneo'),
    path('api/torneo/declarar-ganador/', api_declarar_ganador, name='api_declarar_ganador'),
    path('api/torneo/<uuid:torneo_id>/empezar/', api_empezar_torneo, name='api_empezar_torneo'),
    path('api/torneo/<uuid:torneo_id>/verificar-campeon/', api_verificar_campeon, name='api_verificar_campeon'),
